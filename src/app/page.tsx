...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col gap-8">
      ...
      <div className="bg-white w-full h-80 p-4 rounded-2xl text-text-10">
        <h2 className="font-medium text-xl py-4">Gráfico de re ceitas</h2>
        <Chart />
      </div>
      ...
      <div className="bg-white w-full h-fit p-4 rounded-2xl text-text-10 flex flex-col items-start gap-4">
        <h2 className="font-medium text-xl">Reembolsoss</h2>
